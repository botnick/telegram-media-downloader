 ...
 *      finds a directory containing pnpm-workspace.yaml or
 *      .git/, then appends 'data'. Resilient to monorepo restructures
...
export const DATA_DIR = process.env.TGDL_DATA_DIR
