...
export const FALLBACK_STACK =
    "'IBM Plex Sans', 'IBM Plex Sans Thai', 'Roboto', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif";
...
export const FONTS = [
    ...
    },
    {
        ...
        category: 'latin',
        name: 'Manrope',
        query: 'Manrope:wght@400;500;600;700',
        family: "'Manrope'",
    },
    {
        id: 'dm-sans',
        category: 'latin',
        name: 'DM Sans',
        query: 'DM+Sans:wght@400;500;600;700',
        family: "'DM Sans'",
    },
    {
        id: 'work-sans',
